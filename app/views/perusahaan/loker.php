...
<body>
    ...
    <div class="container-fluid font">
        <div class="row">
            ...
            <div class="position-relative fs-1 btnTambahLoker"><button type="button" class="btnTambahLoker" data-bs-toggle="modal" data-bs-target="#formModal"><i class='bx bxs-plus-square position-absolute bottom-0 end-0'></div></button>
